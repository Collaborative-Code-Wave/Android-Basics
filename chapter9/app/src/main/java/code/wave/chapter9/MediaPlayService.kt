...
class MediaPlayService : Service() {
  ...
  override fun onCreate() {
    ...
    val pausePendingIntent = PendingIntent.getService(
      this,
      0,
      Intent(this, MediaPlayService::class.java).apply { action = MEDIA_PLAYER_PAUSE },
      PendingIntent.FLAG_IMMUTABLE
    )
    val playPendingIntent = PendingIntent.getService(
      this,
      0,
      Intent(this, MediaPlayService::class.java).apply { action = MEDIA_PLAYER_PLAY },
      PendingIntent.FLAG_IMMUTABLE
    )
    val stopPendingIntent = PendingIntent.getService(
      this,
      0,
      Intent(this, MediaPlayService::class.java).apply { action = MEDIA_PLAYER_STOP },
      PendingIntent.FLAG_IMMUTABLE
    )
  ...
  private fun createNotificationChannel() {
    val channel = NotificationChannel(CHANNEL_ID, "MEDIA_PLAYER", NotificationManager.IMPORTANCE_HIGH)
